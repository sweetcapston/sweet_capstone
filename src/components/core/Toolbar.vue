<template>
  <v-toolbar class="gradient white--text" height="50px" app flat>
    ...
    <v-toolbar-title class="headline text-uppercase">
      <img
        class="logo"
        src="https://firebasestorage.googleapis.com/v0/b/openclass-e8b92.appspot.com/o/images%2Flogo_white.png?alt=media&token=a3200e5d-5428-4282-8fe9-e65df67088b4"
        height="40"
        @click="moveToMain()"
      >
    ...
    <v-toolbar-items>
      <v-flex align-center layout py-2>
        <v-icon
          v-if="alarm && this.$store.state.Identity==2"

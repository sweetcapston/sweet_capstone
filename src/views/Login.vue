    ...
    <v-content>
      <section id="main">
        ...
        >
          ...
          >      
            ...
            <v-btn @click="howto()" class="cyan lighten-1 mt-5" dark large>             
      ...
      <section id="how-to-use">
        ...
        >
          ...
          <v-flex xs12 class="how-to-use-big">
                ...
                <v-layout column wrap align-center>
                  <v-flex>
                    <v-btn flat>
                      <v-card class="elevation-0 transparent">
                        <v-card-text class="text-xs-center">
                          <v-icon x-large class="cyan--text text--lighten-1">mdi-google-classroom</v-icon>
                        </v-card-text>
                    ...
                    <v-btn flat>   
                      <v-card class="elevation-0 transparent">
                        <v-card-text class="text-xs-center">
                          <v-icon x-large class="cyan--text text--lighten-1">mdi-application-import</v-icon>
                        </v-card-text>
                        <v-card-title primary-title class="layout justify-center">
          ...
          <v-flex xs12 class="how-to-use-small">
            <v-container grid-list-xl>
              <v-btn-toggle v-model="toggle_one" mandatory>
                <v-layout column wrap align-center>
                  <v-flex>
...
export default {
  ...
  methods: {
    ...
    howto(){
      document.querySelector("body").scrollTop=document.querySelector("#how-to-use").offsetTop;
    },
    goTop(){
...
<style>
  ...
  .how-to-use-big .v-btn {
    width: 200px;
    background-color: #fafafa;
  }
  .how-to-use-small .v-btn {
    width: 100px;
    background-color: #fafafa;
  }
